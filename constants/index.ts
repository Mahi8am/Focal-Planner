...
export const THEMES: Record<
  ColorTheme,
  { name: string; accent: string; accentDark: string }
> = {
...
export type CompletedColor =
  ...
  | "salmon"
  | "glass";
export const COMPLETED_COLORS: Record<
  CompletedColor,
  { name: string; hex: string; glow: string }
> = {
  glass: {
    name: "GLASS BLUE",
    hex: "#BBDCE5",
    glow: "rgba(187, 220, 229, 0.15)",
  },
  sky: { name: "SKY BLUE", hex: "#3498DB", glow: "rgba(52,152,219,0.15)" },
  washed: {
    name: "WASHED BLUE",
    hex: "#547A95",
    glow: "rgba(36, 122, 161, 0.15)",
  },
  ...
  lime: {
    name: "ELECTRIC LIME",
    hex: "#A8E063",
    glow: "rgba(168,224,99,0.15)",
  },
  dandelion: {
    name: "DANDELION",
    hex: "#FFD460",
    glow: "rgba(255, 212, 96, 0.15)",
  },
  orange: {
    name: "EMBER ORANGE",
    hex: "#E67E22",
  ...
  salmon: {
    name: "SUNNY SIDE",
    hex: "#FF9A86",
    glow: "rgba(227, 106, 106, 0.15)",
  },
};

export type FailedColor =
  | "crimsonRed"
  | "deepRed"
  | "burntOrange"
  | "warnYellow"
  ...
  | "fire"
  | "brown";
export const FAILED_COLORS: Record<
  FailedColor,
  { name: string; hex: string; glow: string }
> = {
...
export function buildColors(
  ...
  if (isDark) {
    return {
      red: accentHex,
      redDark: accentDarkHex,
      redDeep: `${accentHex}22`,
      redGlow: `${accentHex}28`,
      bg: "#181818",
      bgCard: "#232323",
      bgElevated: "#2C2C2C",
      bgAccent: "#282828",
  ...
  return {
    red: accentHex,
    redDark: accentDarkHex,
    redDeep: `${accentHex}18`,
    redGlow: `${accentHex}15`,
    bg: "#F2EDED",
    bgCard: "#FFFFFF",
    bgElevated: "#EDE8E8",
    bgAccent: "#F7F2F2",
...
export const FUNNY_QUOTES = [
  ...
  "Go with the flow Or run.",
  "The Dev wants to know your location.",
  "The Dev wants your money.",
];
...
export const ABOUT_SPAM_RESPONSES = [
  ...
  "Sending doctors to your locations.",
];
